...
var G__47831 = devtools.prefs.pref(v);
v = G__47831;
continue;
} else {
return v;
...
}catch (e47777){var _e__29838__auto__ = e47777;
return false;
}})();
...
}catch (e47780){var _e__29838__auto__ = e47780;
return false;
}})();
...
}catch (e47783){var _e__29838__auto__ = e47783;
return false;
}}
}
});
...
var vec__47798 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47798,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47798,(1),null);
...
return cljs.core.some((function (p1__47806_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__47806_SHARP_);
}),template);
});
