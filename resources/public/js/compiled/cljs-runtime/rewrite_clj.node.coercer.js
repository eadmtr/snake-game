...
var comma_57686 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_57687 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_57686),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__57666){
...
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_57687,rewrite_clj.node.protocols.coerce(v),comma_57686);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__57677 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__57677) : f.call(null,G__57677));
})(),sq);
});
