...
var sci$impl$types$IBox$setVal$dyn_59977 = (function (_this,_v){
...
return sci$impl$types$IBox$setVal$dyn_59977(_this,_v);
}
});

var sci$impl$types$IBox$getVal$dyn_59987 = (function (_this){
var x__5393__auto__ = (((_this == null))?null:_this);
...
return sci$impl$types$IBox$getVal$dyn_59987(_this);
}
});
...
var sci$impl$types$IReified$getInterfaces$dyn_59988 = (function (_){
...
return sci$impl$types$IReified$getInterfaces$dyn_59988(_);
}
});

var sci$impl$types$IReified$getMethods$dyn_59990 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$IReified$getMethods$dyn_59990(_);
}
});

var sci$impl$types$IReified$getProtocols$dyn_59991 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$IReified$getProtocols$dyn_59991(_);
}
});
...
var sci$impl$types$SciTypeInstance$_get_type$dyn_59998 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$SciTypeInstance$_get_type$dyn_59998(_);
}
});

var sci$impl$types$SciTypeInstance$_mutate$dyn_59999 = (function (_,k,v){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$SciTypeInstance$_mutate$dyn_59999(_,k,v);
}
});
...
var or__5045__auto____$2 = (function (){var G__59872 = x;
var G__59872__$1 = (((G__59872 == null))?null:cljs.core.meta(G__59872));
if((G__59872__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__59872__$1);
}
})();
...
/** @this {Function} */
(sci.impl.types.type_impl.cljs$lang$applyTo = (function (seq59844){
var G__59845 = cljs.core.first(seq59844);
var seq59844__$1 = cljs.core.next(seq59844);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__59845,seq59844__$1);
}));
...
var or__5045__auto____$1 = (function (){var G__59885 = x;
var G__59885__$1 = (((G__59885 == null))?null:cljs.core.meta(G__59885));
if((G__59885__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__59885__$1);
}
})();
if(cljs.core.truth_(or__5045__auto____$1)){
return or__5045__auto____$1;
...
var sci$impl$types$Stack$stack$dyn_60007 = (function (this$){
...
return sci$impl$types$Stack$stack$dyn_60007(this$);
}
});
...
(sci.impl.types.NodeR.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k59912,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__59919 = k59912;
var G__59919__$1 = (((G__59919 instanceof cljs.core.Keyword))?G__59919.fqn:null);
switch (G__59919__$1) {
case "f":
return self__.f;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k59912,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__59924){
var vec__59925 = p__59924;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59925,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59925,(1),null);
...
(sci.impl.types.NodeR.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__59911){
var self__ = this;
var G__59911__$1 = this;
return (new cljs.core.RecordIter((0),G__59911__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"stack","stack",-793405930)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this59913,other59914){
var self__ = this;
var this59913__$1 = this;
return (((!((other59914 == null)))) && ((((this59913__$1.constructor === other59914.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59913__$1.f,other59914.f)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59913__$1.stack,other59914.stack)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59913__$1.__extmap,other59914.__extmap)))))))));
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k59912){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k59912);

}
}));

(sci.impl.types.NodeR.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__59911){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__59951 = cljs.core.keyword_identical_QMARK_;
var expr__59952 = k__5352__auto__;
if(cljs.core.truth_((pred__59951.cljs$core$IFn$_invoke$arity$2 ? pred__59951.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),expr__59952) : pred__59951.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),expr__59952)))){
return (new sci.impl.types.NodeR(G__59911,self__.stack,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__59951.cljs$core$IFn$_invoke$arity$2 ? pred__59951.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"stack","stack",-793405930),expr__59952) : pred__59951.call(null,new cljs.core.Keyword(null,"stack","stack",-793405930),expr__59952)))){
return (new sci.impl.types.NodeR(self__.f,G__59911,self__.__meta,self__.__extmap,null));
} else {
return (new sci.impl.types.NodeR(self__.f,self__.stack,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__59911),null));
}
}
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__59911){
var self__ = this;
var this__5342__auto____$1 = this;
return (new sci.impl.types.NodeR(self__.f,self__.stack,G__59911,self__.__extmap,self__.__hash));
}));
 ...
 */
sci.impl.types.map__GT_NodeR = (function sci$impl$types$map__GT_NodeR(G__59916){
var extmap__5385__auto__ = (function (){var G__59959 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__59916,new cljs.core.Keyword(null,"f","f",-1597136552),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"stack","stack",-793405930)], 0));
if(cljs.core.record_QMARK_(G__59916)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__59959);
} else {
return G__59959;
}
})();
return (new sci.impl.types.NodeR(new cljs.core.Keyword(null,"f","f",-1597136552).cljs$core$IFn$_invoke$arity$1(G__59916),new cljs.core.Keyword(null,"stack","stack",-793405930).cljs$core$IFn$_invoke$arity$1(G__59916),null,cljs.core.not_empty(extmap__5385__auto__),null));
});

sci.impl.types.eval = (function sci$impl$types$eval(expr,ctx,bindings){
if((expr instanceof sci.impl.types.NodeR)){
var fexpr__59962 = expr.f;
return (fexpr__59962.cljs$core$IFn$_invoke$arity$3 ? fexpr__59962.cljs$core$IFn$_invoke$arity$3(expr,ctx,bindings) : fexpr__59962.call(null,expr,ctx,bindings));
} else {
return expr;
}
});
...
var sci$impl$types$HasName$getName$dyn_60042 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$HasName$getName$dyn_60042(_);
}
});
