...
var len__5769__auto___57323 = arguments.length;
var i__5770__auto___57324 = (0);
while(true){
if((i__5770__auto___57324 < len__5769__auto___57323)){
args__5775__auto__.push((arguments[i__5770__auto___57324]));

var G__57325 = (i__5770__auto___57324 + (1));
i__5770__auto___57324 = G__57325;
continue;
} else {
}
break;
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__57284){
var vec__57289 = p__57284;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57289,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__57269_SHARP_){
var and__5043__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__57269_SHARP_) : allowed_QMARK_.call(null,p1__57269_SHARP_)));
if(and__5043__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__57269_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq57273){
var G__57274 = cljs.core.first(seq57273);
var seq57273__$1 = cljs.core.next(seq57273);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57274,seq57273__$1);
}));
