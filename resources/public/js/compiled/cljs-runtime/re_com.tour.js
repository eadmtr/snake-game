...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__80303_SHARP_,p2__80304_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__80303_SHARP_,p2__80304_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function re_com$tour$initialise_tour_$_iter__80357(s__80358){
return (new cljs.core.LazySeq(null,(function (){
var s__80358__$1 = s__80358;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__80358__$1);
if(temp__5804__auto__){
var s__80358__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__80358__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__80358__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__80360 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__80359 = (0);
while(true){
if((i__80359 < size__5522__auto__)){
var step = cljs.core._nth(c__5521__auto__,i__80359);
cljs.core.chunk_append(b__80360,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__80850 = (i__80359 + (1));
i__80359 = G__80850;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__80360),re_com$tour$initialise_tour_$_iter__80357(cljs.core.chunk_rest(s__80358__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__80360),null);
}
} else {
var step = cljs.core.first(s__80358__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__80357(cljs.core.rest(s__80358__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__80452 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__80452.cljs$core$IFn$_invoke$arity$1 ? fexpr__80452.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__80452.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__80477 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__80477.cljs$core$IFn$_invoke$arity$1 ? fexpr__80477.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__80477.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__80574 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__80574.cljs$core$IFn$_invoke$arity$1 ? fexpr__80574.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__80574.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__80684 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__80684.cljs$core$IFn$_invoke$arity$1 ? fexpr__80684.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__80684.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__80705 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__80705.cljs$core$IFn$_invoke$arity$1 ? fexpr__80705.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__80705.call(null,tour));
})(),true);
} else {
return null;
}
