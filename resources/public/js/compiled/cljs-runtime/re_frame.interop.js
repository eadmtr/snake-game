...
return [(function (){var pred__54341 = cljs.core.instance_QMARK_;
var expr__54342 = reactive_val;
if(cljs.core.truth_((pred__54341.cljs$core$IFn$_invoke$arity$2 ? pred__54341.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__54342) : pred__54341.call(null,reagent.ratom.RAtom,expr__54342)))){
return "ra";
} else {
if(cljs.core.truth_((pred__54341.cljs$core$IFn$_invoke$arity$2 ? pred__54341.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__54342) : pred__54341.call(null,reagent.ratom.RCursor,expr__54342)))){
return "rc";
} else {
if(cljs.core.truth_((pred__54341.cljs$core$IFn$_invoke$arity$2 ? pred__54341.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__54342) : pred__54341.call(null,reagent.ratom.Reaction,expr__54342)))){
return "rx";
} else {
if(cljs.core.truth_((pred__54341.cljs$core$IFn$_invoke$arity$2 ? pred__54341.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__54342) : pred__54341.call(null,reagent.ratom.Track,expr__54342)))){
return "tr";
} else {
return "other";
}
