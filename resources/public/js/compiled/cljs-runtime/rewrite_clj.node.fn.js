...
var sym_seq = (function (){var iter__5523__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__56152(s__56153){
return (new cljs.core.LazySeq(null,(function (){
var s__56153__$1 = s__56153;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__56153__$1);
if(temp__5804__auto__){
var s__56153__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56153__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__56153__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__56155 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__56154 = (0);
while(true){
if((i__56154 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__56154);
...
cljs.core.chunk_append(b__56155,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__56367 = (i__56154 + (1));
i__56154 = G__56367;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56155),rewrite_clj$node$fn$fn_walk_$_iter__56152(cljs.core.chunk_rest(s__56153__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56155),null);
}
} else {
var i = cljs.core.first(s__56153__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__56152(cljs.core.rest(s__56153__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__56141_SHARP_){
var or__5045__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__56141_SHARP_);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return p1__56141_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k56178,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56178,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__56215){
var vec__56218 = p__56215;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56218,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56218,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__56177){
var self__ = this;
var G__56177__$1 = this;
return (new cljs.core.RecordIter((0),G__56177__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56179,other56180){
var self__ = this;
var this56179__$1 = this;
return (((!((other56180 == null)))) && ((((this56179__$1.constructor === other56180.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56179__$1.children,other56180.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56179__$1.__extmap,other56180.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k56178){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k56178);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__56177){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__56305 = cljs.core.keyword_identical_QMARK_;
var expr__56306 = k__5352__auto__;
if(cljs.core.truth_((pred__56305.cljs$core$IFn$_invoke$arity$2 ? pred__56305.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__56306) : pred__56305.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__56306)))){
return (new rewrite_clj.node.fn.FnNode(G__56177,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__56177),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__56177){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__56177,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__56188){
var extmap__5385__auto__ = (function (){var G__56334 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__56188,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__56188)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56334);
} else {
return G__56334;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__56188),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
