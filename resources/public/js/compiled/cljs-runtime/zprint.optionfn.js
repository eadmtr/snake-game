...
var zloc_seq_nc = (function (){var G__64457 = cljs.core.identity;
var G__64458 = new cljs.core.Keyword(null,"zloc","zloc",-2123059767).cljs$core$IFn$_invoke$arity$1(opts);
var fexpr__64456 = new cljs.core.Keyword(null,"zmap-no-comment","zmap-no-comment",1484161325).cljs$core$IFn$_invoke$arity$1(zfn_map);
return (fexpr__64456.cljs$core$IFn$_invoke$arity$2 ? fexpr__64456.cljs$core$IFn$_invoke$arity$2(G__64457,G__64458) : fexpr__64456.call(null,G__64457,G__64458));
})();
var meta_zloc = cljs.core.second(zloc_seq_nc);
var meta_seq = (function (){var fexpr__64470 = new cljs.core.Keyword(null,"zmap-no-comment","zmap-no-comment",1484161325).cljs$core$IFn$_invoke$arity$1(zfn_map);
return (fexpr__64470.cljs$core$IFn$_invoke$arity$2 ? fexpr__64470.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,meta_zloc) : fexpr__64470.call(null,cljs.core.identity,meta_zloc));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"meta","meta",1499536964),(function (){var G__64472 = cljs.core.second(meta_seq);
var fexpr__64471 = new cljs.core.Keyword(null,"ztag","ztag",125694964).cljs$core$IFn$_invoke$arity$1(zfn_map);
return (fexpr__64471.cljs$core$IFn$_invoke$arity$1 ? fexpr__64471.cljs$core$IFn$_invoke$arity$1(G__64472) : fexpr__64471.call(null,G__64472));
})())){
return null;
} else {
...
var result = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__64572_SHARP_,p2__64571_SHARP_){
if(cljs.core.truth_(cljs.core.re_find(cljs.core.first(p2__64571_SHARP_),fn_str))){
return cljs.core.reduced(cljs.core.second(p2__64571_SHARP_));
} else {
return null;
}
}),null,rule_pairs);
...
var fn_str = cljs.core.str.cljs$core$IFn$_invoke$arity$1(fn_name);
var rule_pairs = cljs.core.partition.cljs$core$IFn$_invoke$arity$4((2),(2),cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(null),rules_vec);
var result = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__64600_SHARP_,p2__64599_SHARP_){
var lhs = cljs.core.first(p2__64599_SHARP_);
...
return cljs.core.reduced(cljs.core.second(p2__64599_SHARP_));
} else {
return null;
}
} else {
if(cljs.core.truth_(cljs.core.re_find(cljs.core.first(p2__64599_SHARP_),fn_str))){
return cljs.core.reduced(cljs.core.second(p2__64599_SHARP_));
} else {
return null;
}
