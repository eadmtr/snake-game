...
var _STAR_print_newline_STAR__orig_val__50015_50227 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50016_50228 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50017_50229 = true;
var _STAR_print_fn_STAR__temp_val__50018_50230 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50017_50229);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50018_50230);

try{var _STAR_print_level_STAR__orig_val__50024_50232 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__50025_50233 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__50025_50233);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__50024_50232);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50016_50228);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50015_50227);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq50007){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq50007));
}));
...
var new_formatters = current_formatters.filter((function (p1__50116_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__50116_SHARP_)));
}));
...
var G__50132_50292 = f;
var target__29826__auto___50293 = G__50132_50292;
if(cljs.core.truth_(target__29826__auto___50293)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50132_50292)].join(''),"\n","target__29826__auto__"].join('')));
}

(target__29826__auto___50293["toString"] = (function (){
...
var G__50136_50299 = "%c%s";
var G__50137_50300 = "color:transparent";
var G__50138_50301 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__50136_50299,G__50137_50300,G__50138_50301) : f.call(null,G__50136_50299,G__50137_50300,G__50138_50301));
...
var args__5775__auto__ = [];
var len__5769__auto___50313 = arguments.length;
var i__5770__auto___50315 = (0);
while(true){
if((i__5770__auto___50315 < len__5769__auto___50313)){
args__5775__auto__.push((arguments[i__5770__auto___50315]));

var G__50316 = (i__5770__auto___50315 + (1));
i__5770__auto___50315 = G__50316;
continue;
} else {
}
break;
...
var vec__50161 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50161,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50161,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__50325__delegate = function (add_fmt,add_args){
...
var G__50325 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__50330__i = 0, G__50330__a = new Array(arguments.length -  1);
while (G__50330__i < G__50330__a.length) {G__50330__a[G__50330__i] = arguments[G__50330__i + 1]; ++G__50330__i;}
  add_args = new cljs.core.IndexedSeq(G__50330__a,0,null);
} 
return G__50325__delegate.call(this,add_fmt,add_args);};
G__50325.cljs$lang$maxFixedArity = 1;
G__50325.cljs$lang$applyTo = (function (arglist__50331){
var add_fmt = cljs.core.first(arglist__50331);
var add_args = cljs.core.rest(arglist__50331);
return G__50325__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq50153){
var G__50154 = cljs.core.first(seq50153);
var seq50153__$1 = cljs.core.next(seq50153);
var G__50155 = cljs.core.first(seq50153__$1);
var seq50153__$2 = cljs.core.next(seq50153__$1);
var G__50156 = cljs.core.first(seq50153__$2);
var seq50153__$3 = cljs.core.next(seq50153__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50154,G__50155,G__50156,seq50153__$3);
}));
...
var seq__50169 = cljs.core.seq(features);
var chunk__50170 = null;
var count__50171 = (0);
var i__50172 = (0);
while(true){
if((i__50172 < count__50171)){
var feature = chunk__50170.cljs$core$IIndexed$_nth$arity$2(null,i__50172);
...
var G__50353 = seq__50169;
var G__50354 = chunk__50170;
var G__50355 = count__50171;
var G__50356 = (i__50172 + (1));
seq__50169 = G__50353;
chunk__50170 = G__50354;
count__50171 = G__50355;
i__50172 = G__50356;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__50169);
if(temp__5804__auto__){
var seq__50169__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__50169__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__50169__$1);
var G__50358 = cljs.core.chunk_rest(seq__50169__$1);
var G__50359 = c__5568__auto__;
var G__50360 = cljs.core.count(c__5568__auto__);
var G__50361 = (0);
seq__50169 = G__50358;
chunk__50170 = G__50359;
count__50171 = G__50360;
i__50172 = G__50361;
continue;
} else {
var feature = cljs.core.first(seq__50169__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__50368 = cljs.core.next(seq__50169__$1);
var G__50369 = null;
var G__50370 = (0);
var G__50371 = (0);
seq__50169 = G__50368;
chunk__50170 = G__50369;
count__50171 = G__50370;
i__50172 = G__50371;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o50200 = temp__5802__auto__;
return (o50200["version"]);
} else {
return null;
}
})() == null);
