...
var map__47648 = top_item;
var map__47648__$1 = cljs.core.__destructure_map(map__47648);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47648__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47648__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47648__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e47645){var _e = e47645;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___47699 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___47699)){
var seen_errors_47700 = temp__5802__auto___47699;
if(cljs.core.truth_(seen_errors_47700.has(self))){
} else {
seen_errors_47700.add(self);

var temp__5804__auto___47703 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___47703)){
var sense_47706 = temp__5804__auto___47703;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_47706)].join(''));
} else {
}
}
} else {
