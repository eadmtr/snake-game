...
var G__60984 = rewrite_clj.zip.move.next(rewrite_clj.zip.walk.process_loc(loc,p_QMARK_,f));
loc = G__60984;
continue;
}
break;
...
var G__60989 = rewrite_clj.zip.walk.downmost(rewrite_clj.zip.move.right(loc__$1));
loc = G__60989;
continue;
} else {
if(cljs.core.truth_(rewrite_clj.zip.move.up(loc__$1))){
var G__60990 = rewrite_clj.zip.move.up(loc__$1);
loc = G__60990;
continue;
} else {
return loc__$1;
...
return rewrite_clj.zip.subedit.subedit_node(zloc,(function (p1__60963_SHARP_){
return rewrite_clj.zip.walk.postwalk_subtree(p_QMARK_,f,p1__60963_SHARP_);
}));
}));
