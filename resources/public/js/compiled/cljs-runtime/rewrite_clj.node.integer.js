...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k56061,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56061,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__56115){
var vec__56122 = p__56115;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56122,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56122,(1),null);
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__56060){
var self__ = this;
var G__56060__$1 = this;
return (new cljs.core.RecordIter((0),G__56060__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"base","base",185279322)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56062,other56063){
var self__ = this;
var this56062__$1 = this;
return (((!((other56063 == null)))) && ((((this56062__$1.constructor === other56063.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56062__$1.value,other56063.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56062__$1.base,other56063.base)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56062__$1.__extmap,other56063.__extmap)))))))));
}));
...
var abs_value = (function (){var G__56206 = self__.value;
if((self__.value < (0))){
return (- G__56206);
} else {
return G__56206;
...
var prefix = (function (){var G__56211 = cljs.core.long$(self__.base);
switch (G__56211) {
case (8):
return "0";
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k56061){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k56061);

}
}));

(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__56060){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__56244 = cljs.core.keyword_identical_QMARK_;
var expr__56245 = k__5352__auto__;
if(cljs.core.truth_((pred__56244.cljs$core$IFn$_invoke$arity$2 ? pred__56244.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__56245) : pred__56244.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__56245)))){
return (new rewrite_clj.node.integer.IntNode(G__56060,self__.base,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56244.cljs$core$IFn$_invoke$arity$2 ? pred__56244.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"base","base",185279322),expr__56245) : pred__56244.call(null,new cljs.core.Keyword(null,"base","base",185279322),expr__56245)))){
return (new rewrite_clj.node.integer.IntNode(self__.value,G__56060,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__56060),null));
}
}
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__56060){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,G__56060,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.integer.map__GT_IntNode = (function rewrite_clj$node$integer$map__GT_IntNode(G__56070){
var extmap__5385__auto__ = (function (){var G__56271 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56070,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"base","base",185279322)], 0));
if(cljs.core.record_QMARK_(G__56070)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56271);
} else {
return G__56271;
}
})();
return (new rewrite_clj.node.integer.IntNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__56070),new cljs.core.Keyword(null,"base","base",185279322).cljs$core$IFn$_invoke$arity$1(G__56070),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
