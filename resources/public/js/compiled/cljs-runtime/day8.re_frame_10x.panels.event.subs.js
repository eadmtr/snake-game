...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p__73260,_){
var map__73262 = p__73260;
var map__73262__$1 = cljs.core.__destructure_map(map__73262);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73262__$1,new cljs.core.Keyword(null,"code","code",1586293142));
return code;
})], 0));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","trace-id-for-epoch","day8.re-frame-10x.panels.event.subs/trace-id-for-epoch",728519790),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","code-for-epoch","day8.re-frame-10x.panels.event.subs/code-for-epoch",1888261905)], null),(function (p__73296,_){
var map__73298 = p__73296;
var map__73298__$1 = cljs.core.__destructure_map(map__73298);
var trace_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73298__$1,new cljs.core.Keyword(null,"trace-id","trace-id",681947249));
return trace_id;
})], 0));
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","form-for-epoch","day8.re-frame-10x.panels.event.subs/form-for-epoch",-1506248120),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","code-for-epoch","day8.re-frame-10x.panels.event.subs/code-for-epoch",1888261905)], null),(function (p__73305,_){
var map__73312 = p__73305;
var map__73312__$1 = cljs.core.__destructure_map(map__73312);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73312__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
return form;
})], 0));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","code-open?","day8.re-frame-10x.panels.event.subs/code-open?",1956666991),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964)], null),(function (p__73322,_){
var map__73323 = p__73322;
var map__73323__$1 = cljs.core.__destructure_map(map__73323);
var code_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73323__$1,new cljs.core.Keyword(null,"code-open?","code-open?",1228336744));
return code_open_QMARK_;
})], 0));
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted-form","day8.re-frame-10x.panels.event.subs/highlighted-form",1402683478),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964)], null),(function (p__73329,_){
var map__73331 = p__73329;
var map__73331__$1 = cljs.core.__destructure_map(map__73331);
var highlighted_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73331__$1,new cljs.core.Keyword(null,"highlighted-form","highlighted-form",-1255288753));
...
var G__73516 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,i_s);
var G__73517 = (i_s + (1));
var G__73518 = (i_s_SINGLEQUOTE_ + (1));
v = G__73516;
i_s = G__73517;
i_s_SINGLEQUOTE_ = G__73518;
continue;
} else {
var G__73519 = v;
var G__73520 = (i_s + (1));
var G__73521 = i_s_SINGLEQUOTE_;
v = G__73519;
i_s = G__73520;
i_s_SINGLEQUOTE_ = G__73521;
continue;
...
var vec__73393 = day8.re_frame_10x.panels.event.subs.collapse_whitespace_and_index(form_str);
var form_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73393,(0),null);
var reindex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73393,(1),null);
...
var vec__73405 = result;
var vec__73408 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73405,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73408,(0),null);
var pre_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73408,(1),null);
var matched_form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73408,(2),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73405,(1),null);
...
var start = (function (){var G__73412 = form_str__$1;
var G__73412__$1 = (((G__73412 == null))?null:clojure.string.index_of.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([search_str], 0)),G__73412));
if((G__73412__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__73412__$1);
}
})();
...
var end = (function (){var G__73420 = start;
var G__73420__$1 = (((G__73420 == null))?null:(length + G__73420));
if((G__73420__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__73420__$1);
}
})();
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted-form-bounds","day8.re-frame-10x.panels.event.subs/highlighted-form-bounds",-992076813),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted-form","day8.re-frame-10x.panels.event.subs/highlighted-form",1402683478)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","zprint-form-for-epoch","day8.re-frame-10x.panels.event.subs/zprint-form-for-epoch",279472373)], null),(function (p__73425,_){
var vec__73427 = p__73425;
var highlighted_form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73427,(0),null);
var form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73427,(1),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted?","day8.re-frame-10x.panels.event.subs/highlighted?",-173027178),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","zprint-form-for-epoch","day8.re-frame-10x.panels.event.subs/zprint-form-for-epoch",279472373)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted-form-bounds","day8.re-frame-10x.panels.event.subs/highlighted-form-bounds",-992076813)], null),(function (p__73432,p__73433){
var vec__73439 = p__73432;
var zp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73439,(0),null);
var vec__73442 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73439,(1),null);
var left_bound = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73442,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73442,(1),null);
var vec__73445 = p__73433;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73445,(0),null);
var vec__73448 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73445,(1),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73448,(0),null);
var char$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73448,(1),null);
if((left_bound > (0))){
var line__$1 = (line - (1));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","show-all-code?","day8.re-frame-10x.panels.event.subs/show-all-code?",1829719373),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964)], null),(function (p__73465,_){
var map__73467 = p__73465;
var map__73467__$1 = cljs.core.__destructure_map(map__73467);
var show_all_code_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73467__$1,new cljs.core.Keyword(null,"show-all-code?","show-all-code?",159571286));
return show_all_code_QMARK_;
})], 0));
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","repl-msg-state","day8.re-frame-10x.panels.event.subs/repl-msg-state",1012951853),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964)], null),(function (p__73468,_){
var map__73469 = p__73468;
var map__73469__$1 = cljs.core.__destructure_map(map__73469);
var repl_msg_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73469__$1,new cljs.core.Keyword(null,"repl-msg-state","repl-msg-state",-522274040));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","max-column-width","day8.re-frame-10x.panels.event.subs/max-column-width",-1175866341),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.subs","window-width-rounded","day8.re-frame-10x.panels.settings.subs/window-width-rounded",193095108),(100)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","single-character-width","day8.re-frame-10x.panels.event.subs/single-character-width",1463629101)], null),(function (p__73485,_){
var vec__73487 = p__73485;
var window_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73487,(0),null);
var char_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73487,(1),null);
