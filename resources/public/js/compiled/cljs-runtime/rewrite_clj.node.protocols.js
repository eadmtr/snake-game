...
var rewrite_clj$node$protocols$Node$tag$dyn_56059 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_56059(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_56069 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_56069(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_56071 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_56071(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_56073 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_56073(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_56076 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_56076(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_56084 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_56084(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55748_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__55748_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_56110 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_56110(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_56117 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_56117(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_56127 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_56127(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_56134 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_56134(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_56151 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_56151(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_56159 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_56159(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_56162 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_56162(node);
}
});
...
var map__55989 = cljs.core.meta(node);
var map__55989__$1 = cljs.core.__destructure_map(map__55989);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55989__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55989__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55989__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55989__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__56002,p__56003){
var vec__56009 = p__56002;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56009,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56009,(1),null);
var vec__56012 = p__56003;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56012,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56012,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__56019 = col_extent;
if((row_extent === (0))){
return (G__56019 + col);
} else {
return G__56019;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__56047 = rewrite_clj.node.protocols.children(node);
var G__56047__$1 = (((G__56047 == null))?null:cljs.core.first(G__56047));
if((G__56047__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__56047__$1);
}
} else {
