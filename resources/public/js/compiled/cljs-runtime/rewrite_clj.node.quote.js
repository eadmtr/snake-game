...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k57025,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__57070 = k57025;
var G__57070__$1 = (((G__57070 instanceof cljs.core.Keyword))?G__57070.fqn:null);
switch (G__57070__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57025,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__57101){
var vec__57102 = p__57101;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57102,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57102,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__57024){
var self__ = this;
var G__57024__$1 = this;
return (new cljs.core.RecordIter((0),G__57024__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57026,other57027){
var self__ = this;
var this57026__$1 = this;
return (((!((other57027 == null)))) && ((((this57026__$1.constructor === other57027.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57026__$1.tag,other57027.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57026__$1.prefix,other57027.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57026__$1.sym,other57027.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57026__$1.children,other57027.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57026__$1.__extmap,other57027.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k57025){
var self__ = this;
var this__5350__auto____$1 = this;
var G__57175 = k57025;
var G__57175__$1 = (((G__57175 instanceof cljs.core.Keyword))?G__57175.fqn:null);
switch (G__57175__$1) {
case "tag":
case "prefix":
case "sym":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k57025);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__57024){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__57178 = cljs.core.keyword_identical_QMARK_;
var expr__57179 = k__5352__auto__;
if(cljs.core.truth_((pred__57178.cljs$core$IFn$_invoke$arity$2 ? pred__57178.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__57179) : pred__57178.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__57179)))){
return (new rewrite_clj.node.quote.QuoteNode(G__57024,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57178.cljs$core$IFn$_invoke$arity$2 ? pred__57178.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__57179) : pred__57178.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__57179)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__57024,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57178.cljs$core$IFn$_invoke$arity$2 ? pred__57178.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__57179) : pred__57178.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__57179)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__57024,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57178.cljs$core$IFn$_invoke$arity$2 ? pred__57178.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__57179) : pred__57178.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__57179)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__57024,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__57024),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__57024){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__57024,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__57038){
var extmap__5385__auto__ = (function (){var G__57214 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57038,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__57038)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57214);
} else {
return G__57214;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__57038),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__57038),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__57038),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__57038),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var G__57304 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__57304;
continue;
}
break;
...
var G__57310 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__57310;
continue;
}
break;
...
var G__57311 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__57311;
continue;
}
break;
...
var G__57313 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__57313;
continue;
}
break;
