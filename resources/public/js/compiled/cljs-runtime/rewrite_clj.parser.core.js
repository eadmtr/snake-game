...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__57638 = cljs.core.get_global_hierarchy;
return (fexpr__57638.cljs$core$IFn$_invoke$arity$0 ? fexpr__57638.cljs$core$IFn$_invoke$arity$0() : fexpr__57638.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__57642_SHARP_){
var _STAR_delimiter_STAR__orig_val__57643 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__57644 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__57644);

try{return rewrite_clj.parser.core.parse_next(p1__57642_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__57643);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5775__auto__ = [];
var len__5769__auto___57679 = arguments.length;
var i__5770__auto___57680 = (0);
while(true){
if((i__5770__auto___57680 < len__5769__auto___57679)){
args__5775__auto__.push((arguments[i__5770__auto___57680]));

var G__57681 = (i__5770__auto___57680 + (1));
i__5770__auto___57680 = G__57681;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__57654){
var vec__57655 = p__57654;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57655,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq57648){
var G__57649 = cljs.core.first(seq57648);
var seq57648__$1 = cljs.core.next(seq57648);
var G__57650 = cljs.core.first(seq57648__$1);
var seq57648__$2 = cljs.core.next(seq57648__$1);
var G__57651 = cljs.core.first(seq57648__$2);
var seq57648__$3 = cljs.core.next(seq57648__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57649,G__57650,G__57651,seq57648__$3);
}));
...
var G__57665 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57665)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__57665)){
...
return cljs.core.cons((function (){var G__57671 = rewrite_clj.reader.peek(reader);
switch (G__57671) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__57665)){
