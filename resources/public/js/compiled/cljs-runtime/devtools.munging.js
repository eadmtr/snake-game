...
var o46952 = temp__5802__auto__;
var temp__5802__auto____$1 = (o46952["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o46953 = temp__5802__auto____$1;
return (o46953["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29782__auto__ = f;
return (o__29782__auto__["toString"]).call(o__29782__auto__);
} else {
return "";
}
}catch (e46976){var _ = e46976;
return "";
}});
...
try{var o__29782__auto___47742 = t;
(o__29782__auto___47742["cljs$lang$ctorPrWriter"]).call(o__29782__auto___47742,t,writer);
}catch (e47018){var __47743 = e47018;
}
...
var char_code = (function (){var o__29782__auto__ = (new String(char$));
return (o__29782__auto__["charCodeAt"]).call(o__29782__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29782__auto__ = String;
return (o__29782__auto__["fromCharCode"]).call(o__29782__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__47097 = num_code;
switch (G__47097) {
case (1):
return (185);
...
var o__29782__auto__ = String;
return (o__29782__auto__["fromCharCode"]).call(o__29782__auto__,superscript_code);
});
/**
...
}catch (e47181){var _e__29838__auto__ = e47181;
return false;
}})())){
...
var vec__47190 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47190,(0),null);
...
var len__5769__auto___47763 = arguments.length;
var i__5770__auto___47764 = (0);
while(true){
if((i__5770__auto___47764 < len__5769__auto___47763)){
args__5775__auto__.push((arguments[i__5770__auto___47764]));

var G__47765 = (i__5770__auto___47764 + (1));
i__5770__auto___47764 = G__47765;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__47307){
var vec__47309 = p__47307;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47309,(0),null);
...
var G__47768 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__47769 = cljs.core.butlast(remaining_tokens);
name_tokens = G__47768;
remaining_tokens = G__47769;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq47294){
var G__47295 = cljs.core.first(seq47294);
var seq47294__$1 = cljs.core.next(seq47294);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47295,seq47294__$1);
}));
...
var vec__47338 = cljs.core.split_with((function (p1__47329_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__47329_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47338,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47338,(1),null);
...
var vec__47366 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47366,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47366,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__47773 = cljs.core.rest(remaining_tokens);
var G__47774 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__47773;
name_tokens = G__47774;
continue;
} else {
...
var vec__47400 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47400,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47400,(1),null);
var vec__47403 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47403,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47403,(1),null);
var vec__47406 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47406,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47406,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47406,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47406,(3),null);
...
var vec__47440 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47440,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47440,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47440,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47440,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47440,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47440,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__47458 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47458,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47458,(1),null);
var vec__47463 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47463,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47463,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__47484 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__47484) : devtools.munging.parse_fn_info_deep.call(null,G__47484));
})()));
}
} else {
return fn_info;
...
var G__47801 = (arity + (1));
var G__47802 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__47513){
var vec__47517 = p__47513;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47517,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47517,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47552_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__47552_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47553_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__47553_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___47808 = arguments.length;
var i__5770__auto___47809 = (0);
while(true){
if((i__5770__auto___47809 < len__5769__auto___47808)){
args__5775__auto__.push((arguments[i__5770__auto___47809]));

var G__47810 = (i__5770__auto___47809 + (1));
i__5770__auto___47809 = G__47810;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__47569){
var vec__47570 = p__47569;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47570,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq47560){
var G__47561 = cljs.core.first(seq47560);
var seq47560__$1 = cljs.core.next(seq47560);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47561,seq47560__$1);
}));
...
var map__47607 = options;
var map__47607__$1 = cljs.core.__destructure_map(map__47607);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47607__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47607__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47607__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47607__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__47608 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47608,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47608,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47608,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47608,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47608,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47608,(5),null);
...
var o__29782__auto__ = f;
return (o__29782__auto__["getBasis"]).call(o__29782__auto__);
});
/**
...
}catch (e47619){var _e__29838__auto__ = e47619;
...
var G__47828 = (obj[cljs.core.first(path)]);
var G__47829 = cljs.core.rest(path);
obj = G__47828;
path = G__47829;
continue;
} else {
...
var _STAR_ = (function (accum,p__47651){
var vec__47654 = p__47651;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47654,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47654,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__47667){
var vec__47669 = p__47667;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47669,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47669,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47669,(2),null);
...
var post_process = (function (p__47686){
var vec__47691 = p__47686;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47691,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47691,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47678_SHARP_){
return (obj[cljs.core.first(p1__47678_SHARP_)]);
}),sorted_matches);
