...
var periods__$1 = cljs.core.vec((function (){var G__78741 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__78739_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__78739_SHARP_,(0),(3));
}),G__78741);
} else {
return G__78741;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__78784){
var vec__78785 = p__78784;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78785,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78785,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__78788 = pattern;
switch (G__78788) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78788)].join('')));
...
var G__78808 = key;
var G__78808__$1 = (((G__78808 instanceof cljs.core.Keyword))?G__78808.fqn:null);
switch (G__78808__$1) {
case "millis":
return (function (p1__78799_SHARP_){
return p1__78799_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__78800_SHARP_){
return p1__78800_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__78801_SHARP_){
return p1__78801_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__78802_SHARP_){
return p1__78802_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__78803_SHARP_){
return p1__78803_SHARP_.getHours();
});

break;
case "day":
return (function (p1__78804_SHARP_){
return p1__78804_SHARP_.getDate();
});

break;
case "month":
return (function (p1__78805_SHARP_){
return p1__78805_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__78806_SHARP_){
return p1__78806_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78808__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__78815){
var vec__78819 = p__78815;
var seq__78820 = cljs.core.seq(vec__78819);
var first__78821 = cljs.core.first(seq__78820);
var seq__78820__$1 = cljs.core.next(seq__78820);
var key = first__78821;
var args = seq__78820__$1;
var G__78823 = key;
var G__78823__$1 = (((G__78823 instanceof cljs.core.Keyword))?G__78823.fqn:null);
switch (G__78823__$1) {
case "millis":
...
break;
case "ordinal-suffix":
var vec__78835 = (function (){var G__78838 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__78838) : syntax_list.call(null,G__78838));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78835,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78823__$1)].join('')));
...
var d = value;
var G__78845 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__78846 = G__78845;
var seq__78847 = cljs.core.seq(vec__78846);
var first__78848 = cljs.core.first(seq__78847);
var seq__78847__$1 = cljs.core.next(seq__78847);
var unparser = first__78848;
var more = seq__78847__$1;
var s = "";
var d__$1 = d;
var G__78845__$1 = G__78845;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__78856 = G__78845__$1;
var seq__78857 = cljs.core.seq(vec__78856);
var first__78858 = cljs.core.first(seq__78857);
var seq__78857__$1 = cljs.core.next(seq__78857);
var unparser__$1 = first__78858;
var more__$1 = seq__78857__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__78860 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78860,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78860,(1),null);
var G__78955 = d__$3;
var G__78956 = more__$1;
var G__78957 = s__$3;
d__$1 = G__78955;
G__78845__$1 = G__78956;
s__$1 = G__78957;
continue;
}
break;
