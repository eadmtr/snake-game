...
return [(function (){var pred__49665 = cljs.core.instance_QMARK_;
var expr__49666 = reactive_val;
if(cljs.core.truth_((pred__49665.cljs$core$IFn$_invoke$arity$2 ? pred__49665.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__49666) : pred__49665.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__49666)))){
return "ra";
} else {
if(cljs.core.truth_((pred__49665.cljs$core$IFn$_invoke$arity$2 ? pred__49665.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__49666) : pred__49665.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__49666)))){
return "rc";
} else {
if(cljs.core.truth_((pred__49665.cljs$core$IFn$_invoke$arity$2 ? pred__49665.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__49666) : pred__49665.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__49666)))){
return "rx";
} else {
if(cljs.core.truth_((pred__49665.cljs$core$IFn$_invoke$arity$2 ? pred__49665.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__49666) : pred__49665.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__49666)))){
return "tr";
} else {
return "other";
}
