...
rewrite_clj.node.token.symbol_sexpr = (function rewrite_clj$node$token$symbol_sexpr(value,map_qualifier,p__57051){
var map__57052 = p__57051;
var map__57052__$1 = cljs.core.__destructure_map(map__57052);
var auto_resolve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57052__$1,new cljs.core.Keyword(null,"auto-resolve","auto-resolve",1851201983));
var q = rewrite_clj.node.token.choose_qualifier(map_qualifier,rewrite_clj.node.token.symbol_qualifier(value));
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var G__57054 = (cljs.core.truth_(new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351).cljs$core$IFn$_invoke$arity$1(q))?(function (){var G__57059 = (function (){var or__5045__auto__ = (function (){var G__57060 = new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(q);
if((G__57060 == null)){
return null;
} else {
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__57060);
}
})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
var fexpr__57058 = (function (){var or__5045__auto__ = auto_resolve;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
return (fexpr__57058.cljs$core$IFn$_invoke$arity$1 ? fexpr__57058.cljs$core$IFn$_invoke$arity$1(G__57059) : fexpr__57058.call(null,G__57059));
})():new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(q));
if((G__57054 == null)){
return null;
} else {
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57054);
}
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k57079,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57079,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__57110){
var vec__57111 = p__57110;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57111,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57111,(1),null);
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__57078){
var self__ = this;
var G__57078__$1 = this;
return (new cljs.core.RecordIter((0),G__57078__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"string-value","string-value",1109600561)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57080,other57081){
var self__ = this;
var this57080__$1 = this;
return (((!((other57081 == null)))) && ((((this57080__$1.constructor === other57081.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57080__$1.value,other57081.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57080__$1.string_value,other57081.string_value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57080__$1.__extmap,other57081.__extmap)))))))));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k57079){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k57079);

}
}));

(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__57078){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__57132 = cljs.core.keyword_identical_QMARK_;
var expr__57133 = k__5352__auto__;
if(cljs.core.truth_((pred__57132.cljs$core$IFn$_invoke$arity$2 ? pred__57132.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__57133) : pred__57132.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__57133)))){
return (new rewrite_clj.node.token.TokenNode(G__57078,self__.string_value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57132.cljs$core$IFn$_invoke$arity$2 ? pred__57132.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__57133) : pred__57132.call(null,new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__57133)))){
return (new rewrite_clj.node.token.TokenNode(self__.value,G__57078,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__57078),null));
}
}
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__57078){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,G__57078,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.token.map__GT_TokenNode = (function rewrite_clj$node$token$map__GT_TokenNode(G__57090){
var extmap__5385__auto__ = (function (){var G__57150 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57090,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string-value","string-value",1109600561)], 0));
if(cljs.core.record_QMARK_(G__57090)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57150);
} else {
return G__57150;
}
})();
return (new rewrite_clj.node.token.TokenNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__57090),new cljs.core.Keyword(null,"string-value","string-value",1109600561).cljs$core$IFn$_invoke$arity$1(G__57090),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
(rewrite_clj.node.token.SymbolNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k57160,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__57177 = k57160;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57160,else__5346__auto__);
...
var self__ = this;
var this__5363__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__57185){
var vec__57186 = p__57185;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57186,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57186,(1),null);
return (f__5364__auto__.cljs$core$IFn$_invoke$arity$3 ? f__5364__auto__.cljs$core$IFn$_invoke$arity$3(ret__5366__auto__,k__5367__auto__,v__5368__auto__) : f__5364__auto__.call(null,ret__5366__auto__,k__5367__auto__,v__5368__auto__));
}),init__5365__auto__,this__5363__auto____$1);
}));
...
(rewrite_clj.node.token.SymbolNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57161,other57162){
var self__ = this;
var this57161__$1 = this;
return (((!((other57162 == null)))) && ((((this57161__$1.constructor === other57162.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57161__$1.value,other57162.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57161__$1.string_value,other57162.string_value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57161__$1.map_qualifier,other57162.map_qualifier)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57161__$1.__extmap,other57162.__extmap)))))))))));
}));
...
(rewrite_clj.node.token.SymbolNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k57160){
var self__ = this;
var this__5350__auto____$1 = this;
var G__57226 = k57160;
...
(rewrite_clj.node.token.SymbolNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__57159){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__57227 = cljs.core.keyword_identical_QMARK_;
var expr__57228 = k__5352__auto__;
if(cljs.core.truth_((pred__57227.cljs$core$IFn$_invoke$arity$2 ? pred__57227.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__57228) : pred__57227.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__57228)))){
return (new rewrite_clj.node.token.SymbolNode(G__57159,self__.string_value,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57227.cljs$core$IFn$_invoke$arity$2 ? pred__57227.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__57228) : pred__57227.call(null,new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__57228)))){
return (new rewrite_clj.node.token.SymbolNode(self__.value,G__57159,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57227.cljs$core$IFn$_invoke$arity$2 ? pred__57227.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__57228) : pred__57227.call(null,new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__57228)))){
return (new rewrite_clj.node.token.SymbolNode(self__.value,self__.string_value,G__57159,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.token.SymbolNode(self__.value,self__.string_value,self__.map_qualifier,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__57159),null));
}
}
}
}));
...
(rewrite_clj.node.token.SymbolNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__57159){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.token.SymbolNode(self__.value,self__.string_value,self__.map_qualifier,G__57159,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.token.map__GT_SymbolNode = (function rewrite_clj$node$token$map__GT_SymbolNode(G__57166){
var extmap__5385__auto__ = (function (){var G__57234 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57166,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string-value","string-value",1109600561),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720)], 0));
if(cljs.core.record_QMARK_(G__57166)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57234);
} else {
return G__57234;
}
})();
return (new rewrite_clj.node.token.SymbolNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__57166),new cljs.core.Keyword(null,"string-value","string-value",1109600561).cljs$core$IFn$_invoke$arity$1(G__57166),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720).cljs$core$IFn$_invoke$arity$1(G__57166),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
