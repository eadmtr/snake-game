...
var G__53617 = o;
reagent.impl.template.goog$module$goog$object.set(G__53617,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__53718__delegate = function (args){
...
while (G__53719__i < G__53719__a.length) {G__53719__a[G__53719__i] = arguments[G__53719__i + 0]; ++G__53719__i;}
  args = new cljs.core.IndexedSeq(G__53719__a,0,null);
} 
return G__53718__delegate.call(this,args);};
G__53718.cljs$lang$maxFixedArity = 0;
G__53718.cljs$lang$applyTo = (function (arglist__53720){
var args = cljs.core.seq(arglist__53720);
return G__53718__delegate(args);
});
...
var G__53638 = o;
reagent.impl.template.goog$module$goog$object.set(G__53638,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__53726__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__53726 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__53727__i = 0, G__53727__a = new Array(arguments.length -  0);
while (G__53727__i < G__53727__a.length) {G__53727__a[G__53727__i] = arguments[G__53727__i + 0]; ++G__53727__i;}
  args = new cljs.core.IndexedSeq(G__53727__a,0,null);
} 
return G__53726__delegate.call(this,args);};
G__53726.cljs$lang$maxFixedArity = 0;
G__53726.cljs$lang$applyTo = (function (arglist__53728){
var args = cljs.core.seq(arglist__53728);
return G__53726__delegate(args);
});
G__53726.cljs$core$IFn$_invoke$arity$variadic = G__53726__delegate;
return G__53726;
})()
;
} else {
...
var G__53649 = props;
var G__53649__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53649,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__53649);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53649__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__53656 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53656,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__53656;
}
})(),id_class);
...
var G__53659 = (cljs.core.count(argv) - first_child);
switch (G__53659) {
case (0):
...
var vec__53663 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53663,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53663,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53663,(2),null);
...
var temp__5808__auto___53739 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___53739 == null)){
} else {
var key_53740 = temp__5808__auto___53739;
(jsprops.key = key_53740);
}
...
var temp__5808__auto___53741 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___53741 == null)){
} else {
var key_53742 = temp__5808__auto___53741;
(jsprops.key = key_53742);
}
...
var temp__5808__auto___53746 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___53746 == null)){
} else {
var key_53747 = temp__5808__auto___53746;
(jsprops.key = key_53747);
}
...
var temp__5808__auto___53752 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___53752 == null)){
} else {
var key_53753 = temp__5808__auto___53752;
(jsprops.key = key_53753);
}
...
var temp__5808__auto___53755 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___53755 == null)){
} else {
var key_53756 = temp__5808__auto___53755;
(jsprops.key = key_53756);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53666_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__53666_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__53667 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53667,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53667,(1),null);
...
break;
default:
var G__53763 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__53764 = compiler;
v = G__53763;
compiler = G__53764;
continue;
...
var G__53671 = tag;
var G__53671__$1 = (((G__53671 instanceof cljs.core.Keyword))?G__53671.fqn:null);
switch (G__53671__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template53689 = (function (opts,id,fn_to_element,parse_fn,meta53690){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template53689.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_53691,meta53690__$1){
var self__ = this;
var _53691__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template53689(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta53690__$1));
}));

(reagent.impl.template.t_reagent$impl$template53689.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_53691){
var self__ = this;
var _53691__$1 = this;
return self__.meta53690;
}));

(reagent.impl.template.t_reagent$impl$template53689.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template53689.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template53689.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template53689.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template53689.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template53689.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta53690","meta53690",-1890727859,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template53689.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template53689.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template53689");

(reagent.impl.template.t_reagent$impl$template53689.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template53689");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template53689.
 */
reagent.impl.template.__GT_t_reagent$impl$template53689 = (function reagent$impl$template$__GT_t_reagent$impl$template53689(opts,id,fn_to_element,parse_fn,meta53690){
return (new reagent.impl.template.t_reagent$impl$template53689(opts,id,fn_to_element,parse_fn,meta53690));
});
...
return (new reagent.impl.template.t_reagent$impl$template53689(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
