...
}catch (e51815){var _e__29838__auto__ = e51815;
return false;
...
}catch (e51826){var _e__29838__auto__ = e51826;
return false;
...
}catch (e51830){var _e__29838__auto__ = e51830;
return false;
...
}catch (e51832){var _e__29838__auto__ = e51832;
return false;
...
}catch (e51841){var _e__29838__auto__ = e51841;
return false;
}})())){
...
}catch (e51843){var _e__29838__auto__ = e51843;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__51848 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__51849 = (function (){var or__5045__auto__ = config;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__51849);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__51848);
}});
});
...
return (function() { 
var G__51885__delegate = function (args){
...
while (G__51886__i < G__51886__a.length) {G__51886__a[G__51886__i] = arguments[G__51886__i + 0]; ++G__51886__i;}
  args = new cljs.core.IndexedSeq(G__51886__a,0,null);
} 
return G__51885__delegate.call(this,args);};
...
return G__51885__delegate(args);
});
