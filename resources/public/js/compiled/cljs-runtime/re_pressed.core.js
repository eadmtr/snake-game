...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","add-keyboard-event-listener","re-pressed.core/add-keyboard-event-listener",719500381),(function (_,p__23413){
var vec__23415 = p__23413;
...
var ___$1 = first__23417;
var first__23417__$1 = cljs.core.first(seq__23416__$1);
var seq__23416__$2 = cljs.core.next(seq__23416__$1);
var event_type = first__23417__$1;
var map__23418 = seq__23416__$2;
var map__23418__$1 = cljs.core.__destructure_map(map__23418);
var args_map = map__23418__$1;
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","set-keydown-rules","re-pressed.core/set-keydown-rules",1002257871),(function (p__23421,p__23422){
var map__23423 = p__23421;
var map__23423__$1 = cljs.core.__destructure_map(map__23423);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23423__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__23424 = p__23422;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23424,(0),null);
var map__23427 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23424,(1),null);
var map__23427__$1 = cljs.core.__destructure_map(map__23427);
var opts = map__23427__$1;
var event_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23427__$1,new cljs.core.Keyword(null,"event-keys","event-keys",-835966631));
var clear_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23427__$1,new cljs.core.Keyword(null,"clear-keys","clear-keys",-1035470539));
var always_listen_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23427__$1,new cljs.core.Keyword(null,"always-listen-keys","always-listen-keys",497991050));
var prevent_default_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23427__$1,new cljs.core.Keyword(null,"prevent-default-keys","prevent-default-keys",1744205310));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","set-keypress-rules","re-pressed.core/set-keypress-rules",1541561860),(function (p__23428,p__23429){
var map__23430 = p__23428;
var map__23430__$1 = cljs.core.__destructure_map(map__23430);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23430__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__23431 = p__23429;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23431,(0),null);
var map__23434 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23431,(1),null);
var map__23434__$1 = cljs.core.__destructure_map(map__23434);
var opts = map__23434__$1;
var event_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23434__$1,new cljs.core.Keyword(null,"event-keys","event-keys",-835966631));
var clear_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23434__$1,new cljs.core.Keyword(null,"clear-keys","clear-keys",-1035470539));
var always_listen_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23434__$1,new cljs.core.Keyword(null,"always-listen-keys","always-listen-keys",497991050));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","set-keyup-rules","re-pressed.core/set-keyup-rules",519284589),(function (p__23435,p__23436){
var map__23437 = p__23435;
var map__23437__$1 = cljs.core.__destructure_map(map__23437);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23437__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__23438 = p__23436;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23438,(0),null);
var map__23441 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23438,(1),null);
var map__23441__$1 = cljs.core.__destructure_map(map__23441);
var opts = map__23441__$1;
var event_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23441__$1,new cljs.core.Keyword(null,"event-keys","event-keys",-835966631));
var clear_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23441__$1,new cljs.core.Keyword(null,"clear-keys","clear-keys",-1035470539));
var always_listen_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23441__$1,new cljs.core.Keyword(null,"always-listen-keys","always-listen-keys",497991050));
