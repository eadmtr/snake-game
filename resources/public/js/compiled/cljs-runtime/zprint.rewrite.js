...
var G__64005 = rewrite_clj.zip.next(n);
loc = G__64005;
continue;
} else {
var G__64007 = rewrite_clj.zip.next(loc);
loc = G__64007;
continue;
}
} else {
var G__64008 = rewrite_clj.zip.next(loc);
loc = G__64008;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__63913 = zloc;
var G__63913__$1 = (((G__63913 == null))?null:rewrite_clj.zip.node(G__63913));
if((G__63913__$1 == null)){
return null;
} else {
return rewrite_clj.zip.of_node_STAR_.cljs$core$IFn$_invoke$arity$1(G__63913__$1);
}
})())));
});
/**
...
var G__64056 = rewrite_clj.zip.down(nloc);
nloc = G__64056;
continue;
}
break;
...
var G__64065 = rewrite_clj.zip.right(nloc);
var G__64066 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__64065;
out = G__64066;
continue;
} else {
...
var G__64084 = rewrite_clj.zip.right(replaced_loc);
var G__64085 = cljs.core.next(new_loc);
var G__64086 = replaced_loc;
nloc = G__64084;
new_loc = G__64085;
last_loc = G__64086;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__63969_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__63969_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__63969_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
