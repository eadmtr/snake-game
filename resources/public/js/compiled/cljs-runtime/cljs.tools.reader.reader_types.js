...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_52316 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_52316(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_52317 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_52317(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_52319 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_52319(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_52328 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_52328(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_52337 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_52337(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_52338 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_52338(reader);
}
});
...
var G__52460 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__52461 = s.append(c);
c = G__52460;
s = G__52461;
continue;
}
