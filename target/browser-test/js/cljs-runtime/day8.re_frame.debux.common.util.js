...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__44731){
var vec__44733 = p__44731;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44733,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44733,(1),null);
...
return clojure.zip.zipper((function (p1__44736_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__44736_SHARP_)) || (cljs.core.map_QMARK_(p1__44736_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__44754){
var vec__44755 = p__44754;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44755,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44755,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__44774_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__44774_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44773_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__44773_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__44778_SHARP_){
return (((p1__44778_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__44778_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__44802,mapping){
var map__44803 = p__44802;
var map__44803__$1 = cljs.core.__destructure_map(map__44803);
var state = map__44803__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44803__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44803__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44803__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__44801_SHARP_){
var and__5043__auto__ = (p1__44801_SHARP_ instanceof cljs.core.Symbol);
if(and__5043__auto__){
return cljs.core.namespace(p1__44801_SHARP_);
} else {
...
var G__44946 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__44947 = clojure.zip.next(loc);
loc = G__44947;
continue;
}
}
...
var len__5769__auto___44959 = arguments.length;
var i__5770__auto___44960 = (0);
while(true){
if((i__5770__auto___44960 < len__5769__auto___44959)){
args__5775__auto__.push((arguments[i__5770__auto___44960]));

var G__44961 = (i__5770__auto___44960 + (1));
i__5770__auto___44960 = G__44961;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__44874){
var vec__44875 = p__44874;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44875,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq44871){
var G__44872 = cljs.core.first(seq44871);
var seq44871__$1 = cljs.core.next(seq44871);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44872,seq44871__$1);
}));
...
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__44882_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__44885_44962 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__44886_44963 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__44887_44964 = true;
var _STAR_print_fn_STAR__temp_val__44888_44965 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__44887_44964);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__44888_44965);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__44886_44963);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__44885_44962);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5690__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__44884_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__44884_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__44967 = cljs.core.next(opts__$1);
var G__44968 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__44967;
acc = G__44968;
continue;
} else {
if(typeof f === 'string'){
var G__44969 = cljs.core.next(opts__$1);
var G__44970 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__44969;
acc = G__44970;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__44971 = cljs.core.nnext(opts__$1);
var G__44972 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__44971;
acc = G__44972;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__44973 = cljs.core.next(opts__$1);
var G__44974 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__44973;
acc = G__44974;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__44912 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__44912.cljs$core$IFn$_invoke$arity$1 ? fexpr__44912.cljs$core$IFn$_invoke$arity$1(f) : fexpr__44912.call(null,f));
})())){
var G__44976 = cljs.core.next(opts__$1);
var G__44977 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__44976;
acc = G__44977;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__44915 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__44915.cljs$core$IFn$_invoke$arity$1 ? fexpr__44915.cljs$core$IFn$_invoke$arity$1(f) : fexpr__44915.call(null,f));
})())){
var G__44978 = cljs.core.nnext(opts__$1);
var G__44979 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__44978;
acc = G__44979;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__44980 = cljs.core.next(opts__$1);
var G__44981 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__44980;
acc = G__44981;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__44916){
var vec__44917 = p__44916;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44917,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44917,(1),null);
...
var G__44921 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__44920 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__44920.cljs$core$IFn$_invoke$arity$1 ? fexpr__44920.cljs$core$IFn$_invoke$arity$1(G__44921) : fexpr__44920.call(null,G__44921));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__44923 = quoted_form;
var G__44924 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__44923,G__44924) : day8.re_frame.debux.common.util.remove_d.call(null,G__44923,G__44924));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__44925 = quoted_form;
var G__44926 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__44925,G__44926) : day8.re_frame.debux.common.util.remove_d.call(null,G__44925,G__44926));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__44987__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__44927 = quoted_form;
var G__44928 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__44927,G__44928) : day8.re_frame.debux.common.util.remove_d.call(null,G__44927,G__44928));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__44990__i < G__44990__a.length) {G__44990__a[G__44990__i] = arguments[G__44990__i + 0]; ++G__44990__i;}
  arg = new cljs.core.IndexedSeq(G__44990__a,0,null);
} 
return G__44987__delegate.call(this,arg);};
G__44987.cljs$lang$maxFixedArity = 0;
G__44987.cljs$lang$applyTo = (function (arglist__44991){
var arg = cljs.core.seq(arglist__44991);
return G__44987__delegate(arg);
});
...
var G__44999 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__44999;
continue;
} else {
...
var G__45000 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__45000;
continue;
} else {
var G__45001 = clojure.zip.next(loc);
loc = G__45001;
continue;
