...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_39985 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_39985(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_39986 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_39986(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_39989 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_39989(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_39991 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_39991(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_39992 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_39992(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_39993 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_39993(reader);
}
});
...
var G__40061 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__40062 = s.append(c);
c = G__40061;
s = G__40062;
continue;
}
