...
var node = (function (){var G__44461 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__44462 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__44463 = style_string_44832;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__44461,G__44462,G__44463) : cljs_test_display.core.n.call(null,G__44461,G__44462,G__44463));
})();
...
var len__5769__auto___44840 = arguments.length;
var i__5770__auto___44841 = (0);
while(true){
if((i__5770__auto___44841 < len__5769__auto___44840)){
args__5775__auto__.push((arguments[i__5770__auto___44841]));

var G__44842 = (i__5770__auto___44841 + (1));
i__5770__auto___44841 = G__44842;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq44465){
var G__44466 = cljs.core.first(seq44465);
var seq44465__$1 = cljs.core.next(seq44465);
var G__44467 = cljs.core.first(seq44465__$1);
var seq44465__$2 = cljs.core.next(seq44465__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44466,G__44467,seq44465__$2);
}));
...
var vec__44483 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44483,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44483,(1),null);
var G__44492 = cljs.core.PersistentArrayMap.EMPTY;
var G__44492__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44492,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__44492);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44492__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__44492__$1;
}
} else {
...
return (function() { 
var G__44866__delegate = function (klass,contents){
var vec__44495 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44495,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44495,(1),null);
...
var G__44866 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__44867__i = 0, G__44867__a = new Array(arguments.length -  1);
while (G__44867__i < G__44867__a.length) {G__44867__a[G__44867__i] = arguments[G__44867__i + 1]; ++G__44867__i;}
  contents = new cljs.core.IndexedSeq(G__44867__a,0,null);
} 
return G__44866__delegate.call(this,klass,contents);};
G__44866.cljs$lang$maxFixedArity = 1;
G__44866.cljs$lang$applyTo = (function (arglist__44868){
var klass = cljs.core.first(arglist__44868);
var contents = cljs.core.rest(arglist__44868);
return G__44866__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__44575){
var map__44579 = p__44575;
var map__44579__$1 = cljs.core.__destructure_map(map__44579);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44579__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44579__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__44645){
var map__44646 = p__44645;
var map__44646__$1 = cljs.core.__destructure_map(map__44646);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44646__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44646__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__44656){
var map__44657 = p__44656;
var map__44657__$1 = cljs.core.__destructure_map(map__44657);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44657__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44657__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__44670_SHARP_){
return cljs.core.cons(new_current_node,p1__44670_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__44688 = cljs_test_display.core.current_var_info();
var map__44688__$1 = cljs.core.__destructure_map(map__44688);
var info = map__44688__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44688__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44688__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44688__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__44683_SHARP_){
return cljs.core.cons(node,p1__44683_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__44699){
var map__44700 = p__44699;
var map__44700__$1 = cljs.core.__destructure_map(map__44700);
var m = map__44700__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44700__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44700__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44700__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44700__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__44722 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__44722) : formatter_fn.call(null,G__44722));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__44730 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__44730) : formatter_fn.call(null,G__44730));
})()], 0));
});
...
var temp__5804__auto___44902 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___44902)){
var message_44903 = temp__5804__auto___44902;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_44903], 0));
} else {
}
...
var temp__5804__auto___44907 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___44907)){
var message_44909 = temp__5804__auto___44907;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_44909], 0));
} else {
}
