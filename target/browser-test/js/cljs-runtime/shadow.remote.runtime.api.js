...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31597 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31597(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_31602 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_31602(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_31613 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_31613(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_31621 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_31621(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31628 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31628(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31636 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31636(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__31571,callback){
var map__31573 = p__31571;
var map__31573__$1 = cljs.core.__destructure_map(map__31573);
var input = map__31573__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31573__$1,new cljs.core.Keyword(null,"code","code",1586293142));
