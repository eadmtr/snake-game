...
var G__39200 = o;
reagent.impl.template.goog$module$goog$object.set(G__39200,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__39225 = o;
reagent.impl.template.goog$module$goog$object.set(G__39225,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__39456__i < G__39456__a.length) {G__39456__a[G__39456__i] = arguments[G__39456__i + 0]; ++G__39456__i;}
  args = new cljs.core.IndexedSeq(G__39456__a,0,null);
} 
return G__39454__delegate.call(this,args);};
G__39454.cljs$lang$maxFixedArity = 0;
G__39454.cljs$lang$applyTo = (function (arglist__39461){
var args = cljs.core.seq(arglist__39461);
...
var G__39229 = props;
var G__39229__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39229,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39229);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39229__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39239 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39239,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39239;
}
})(),id_class);
...
var G__39253 = (cljs.core.count(argv) - first_child);
switch (G__39253) {
case (0):
...
var vec__39265 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39265,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39265,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39265,(2),null);
...
var temp__5808__auto___39496 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___39496 == null)){
} else {
var key_39498 = temp__5808__auto___39496;
(jsprops.key = key_39498);
}
...
var temp__5808__auto___39499 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___39499 == null)){
} else {
var key_39504 = temp__5808__auto___39499;
(jsprops.key = key_39504);
}
...
var temp__5808__auto___39518 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___39518 == null)){
} else {
var key_39521 = temp__5808__auto___39518;
(jsprops.key = key_39521);
}
...
var temp__5808__auto___39577 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___39577 == null)){
} else {
var key_39579 = temp__5808__auto___39577;
(jsprops.key = key_39579);
}
...
var temp__5808__auto___39587 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___39587 == null)){
} else {
var key_39593 = temp__5808__auto___39587;
(jsprops.key = key_39593);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39336_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39336_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39343 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39343,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39343,(1),null);
...
break;
default:
var G__39644 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__39645 = compiler;
v = G__39644;
compiler = G__39645;
continue;
...
var G__39377 = tag;
var G__39377__$1 = (((G__39377 instanceof cljs.core.Keyword))?G__39377.fqn:null);
switch (G__39377__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template39395 = (function (opts,id,fn_to_element,parse_fn,meta39396){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta39396 = meta39396;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template39395.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39397,meta39396__$1){
var self__ = this;
var _39397__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39395(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta39396__$1));
}));

(reagent.impl.template.t_reagent$impl$template39395.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39397){
var self__ = this;
var _39397__$1 = this;
return self__.meta39396;
}));

(reagent.impl.template.t_reagent$impl$template39395.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39395.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39395.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template39395.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39395.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39395.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta39396","meta39396",784565599,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template39395.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39395.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39395");

(reagent.impl.template.t_reagent$impl$template39395.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template39395");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39395.
 */
reagent.impl.template.__GT_t_reagent$impl$template39395 = (function reagent$impl$template$__GT_t_reagent$impl$template39395(opts,id,fn_to_element,parse_fn,meta39396){
return (new reagent.impl.template.t_reagent$impl$template39395(opts,id,fn_to_element,parse_fn,meta39396));
});
...
return (new reagent.impl.template.t_reagent$impl$template39395(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
