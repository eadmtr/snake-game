...
var len__5769__auto___31372 = arguments.length;
var i__5770__auto___31373 = (0);
while(true){
if((i__5770__auto___31373 < len__5769__auto___31372)){
args_arr__5794__auto__.push((arguments[i__5770__auto___31373]));

var G__31374 = (i__5770__auto___31373 + (1));
i__5770__auto___31373 = G__31374;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq31319){
...
var G__31322 = cljs.core.first(seq31319__$2);
var seq31319__$3 = cljs.core.next(seq31319__$2);
var G__31323 = cljs.core.first(seq31319__$3);
var seq31319__$4 = cljs.core.next(seq31319__$3);
var G__31324 = cljs.core.first(seq31319__$4);
var seq31319__$5 = cljs.core.next(seq31319__$4);
var G__31325 = cljs.core.first(seq31319__$5);
var seq31319__$6 = cljs.core.next(seq31319__$5);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31320,G__31321,G__31322,G__31323,G__31324,G__31325,seq31319__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__31343){
var vec__31344 = p__31343;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31344,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31344,(1),null);
