...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38901 = c;
var G__38901__$1 = (((G__38901 == null))?null:G__38901.prototype);
if((G__38901__$1 == null)){
return null;
} else {
return G__38901__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38910 = c;
var G__38910__$1 = (((G__38910 == null))?null:G__38910.prototype);
if((G__38910__$1 == null)){
return null;
} else {
return G__38910__$1.render;
}
})() == null)))));
});
...
var G__38925 = c;
var G__38925__$1 = (((G__38925 == null))?null:G__38925.constructor);
if((G__38925__$1 == null)){
return null;
} else {
return G__38925__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__38927 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38928 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38928);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38927);
}});
...
var c = this;
var G__38969_39103 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__38969_39103 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38969_39103);
}
...
var renders_39111 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_39112 = cljs.core.first(cljs.core.vals(renders_39111));
...
if((cljs.core.count(renders_39111) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_39111))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_39112)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_39112], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__39032 = o;
reagent.impl.component.goog$module$goog$object.set(G__39032,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__39053 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__39054 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__39054);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__39053);
}});
...
var vec__39057 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39057,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39057,(1),null);
...
var G__39061 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__39061 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__39061);
}
});
}),[]);
