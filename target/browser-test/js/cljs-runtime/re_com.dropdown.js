...
var G__42616 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(choices,new_index);
return (id_fn.cljs$core$IFn$_invoke$arity$1 ? id_fn.cljs$core$IFn$_invoke$arity$1(G__42616) : id_fn.call(null,G__42616));
} else {
return null;
}
});
...
var group_headers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42617_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"group","group",582596132)],[cljs.core.gensym.cljs$core$IFn$_invoke$arity$0(),p1__42617_SHARP_]);
...
}catch (e42671){if((e42671 instanceof Object)){
var e = e42671;
return null;
} else {
throw e42671;
...
var len__5769__auto___43479 = arguments.length;
var i__5770__auto___43480 = (0);
while(true){
if((i__5770__auto___43480 < len__5769__auto___43479)){
args__5775__auto__.push((arguments[i__5770__auto___43480]));

var G__43481 = (i__5770__auto___43480 + (1));
i__5770__auto___43480 = G__43481;
continue;
} else {
}
break;
...
(re_com.dropdown.insert.cljs$core$IFn$_invoke$arity$variadic = (function (p__42695){
var map__42696 = p__42695;
var map__42696__$1 = cljs.core.__destructure_map(map__42696);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42696__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var sel_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42696__$1,new cljs.core.Keyword(null,"sel-start","sel-start",175359789));
var sel_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42696__$1,new cljs.core.Keyword(null,"sel-end","sel-end",81085265));
var ins = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42696__$1,new cljs.core.Keyword(null,"ins","ins",-1021983570));
...
/** @this {Function} */
(re_com.dropdown.insert.cljs$lang$applyTo = (function (seq42688){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq42688));
}));
...
(re_com.dropdown.auto_complete.cljs$core$IFn$_invoke$arity$variadic = (function (p__42717){
var map__42718 = p__42717;
var map__42718__$1 = cljs.core.__destructure_map(map__42718);
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42718__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42718__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var sel_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42718__$1,new cljs.core.Keyword(null,"sel-start","sel-start",175359789));
var sel_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42718__$1,new cljs.core.Keyword(null,"sel-end","sel-end",81085265));
var ins = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42718__$1,new cljs.core.Keyword(null,"ins","ins",-1021983570));
...
var find = (function (p1__42705_SHARP_){
return goog.string.caseInsensitiveStartsWith(p1__42705_SHARP_,text_SINGLEQUOTE_);
});
...
/** @this {Function} */
(re_com.dropdown.auto_complete.cljs$lang$applyTo = (function (seq42706){
var self__5755__auto__ = this;
...
var G__42790_43500 = event.target.value;
(set_filter_text.cljs$core$IFn$_invoke$arity$1 ? set_filter_text.cljs$core$IFn$_invoke$arity$1(G__42790_43500) : set_filter_text.call(null,G__42790_43500));
 ...
 */
re_com.dropdown.filter_text_box = cljs.core.with_meta(re_com.dropdown.filter_text_box_base,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (p1__42794_SHARP_){
var node = reagent.dom.dom_node(p1__42794_SHARP_).firstChild;
return node.focus();
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (p1__42795_SHARP_){
var node = reagent.dom.dom_node(p1__42795_SHARP_).firstChild;
return node.focus();
})], null));
/**
...
var text = (cljs.core.truth_(cljs.core.deref(internal_model))?(function (){var G__42818 = re_com.util.item_for_id.cljs$core$IFn$_invoke$arity$variadic(cljs.core.deref(internal_model),choices,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"id-fn","id-fn",316222798),id_fn], 0));
return (label_fn.cljs$core$IFn$_invoke$arity$1 ? label_fn.cljs$core$IFn$_invoke$arity$1(G__42818) : label_fn.call(null,G__42818));
})():placeholder);
...
var ins_SINGLEQUOTE_ = (function (){var G__42845 = ins;
...
return re_com.dropdown.capitalize_first_letter(G__42845);
} else {
return G__42845;
}
})();
...
var map__42850 = auto_complete_ret;
var map__42850__$1 = cljs.core.__destructure_map(map__42850);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42850__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var sel_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42850__$1,new cljs.core.Keyword(null,"sel-start","sel-start",175359789));
var sel_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42850__$1,new cljs.core.Keyword(null,"sel-end","sel-end",81085265));
...
var ins_43521 = event.key;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(ins_43521),(1))){
re_com.dropdown.handle_free_text_insertion(event,ins_43521,auto_complete_QMARK_,capitalize_QMARK_,choices,internal_model,free_text_sel_range,free_text_change);
} else {
}

return null;
}),placeholder,disabled_QMARK_,(function (p1__42868_SHARP_){
return cljs.core.reset_BANG_(free_text_input,p1__42868_SHARP_);
}),(function (event){
...
var ins_43523 = event.clipboardData.getData("Text");
re_com.dropdown.handle_free_text_insertion(event,ins_43523,auto_complete_QMARK_,capitalize_QMARK_,choices,internal_model,free_text_sel_range,free_text_change);
...
var value_43527 = event.target.value;
var G__42911_43528 = (function (){var G__42913 = value_43527;
if(cljs.core.truth_(capitalize_QMARK_)){
return re_com.dropdown.capitalize_first_letter(G__42913);
} else {
return G__42913;
}
})();
(free_text_change.cljs$core$IFn$_invoke$arity$1 ? free_text_change.cljs$core$IFn$_invoke$arity$1(G__42911_43528) : free_text_change.call(null,G__42911_43528));
 ...
 */
re_com.dropdown.free_text_dropdown_top = cljs.core.with_meta(re_com.dropdown.free_text_dropdown_top_base,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (p1__42924_SHARP_){
var vec__42936 = reagent.core.argv(p1__42924_SHARP_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42936,(0),null);
var free_text_input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42936,(1),null);
var select_free_text_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42936,(2),null);
var free_text_focused_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42936,(3),null);
var free_text_sel_range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42936,(4),null);
...
var callback = (function (p__42964){
var map__42966 = p__42964;
var map__42966__$1 = cljs.core.__destructure_map(map__42966);
var args = map__42966__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42966__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42966__$1,new cljs.core.Keyword(null,"error","error",-978969032));
...
var G__42969 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"filter-text","filter-text",-381699202),text,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668),regex_filter_QMARK_], null);
var G__42970 = (function (p1__42950_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"result","result",1415092211),p1__42950_SHARP_], null));
});
var G__42971 = (function (p1__42951_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),p1__42951_SHARP_], null));
});
return (choices.cljs$core$IFn$_invoke$arity$3 ? choices.cljs$core$IFn$_invoke$arity$3(G__42969,G__42970,G__42971) : choices.call(null,G__42969,G__42970,G__42971));
});
/**
...
var temp__5804__auto___43544 = new cljs.core.Keyword(null,"timer","timer",-1266967739).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state));
if(cljs.core.truth_(temp__5804__auto___43544)){
var timer_43545 = temp__5804__auto___43544;
clearTimeout(timer_43545);
} else {
}
...
var args__5775__auto__ = [];
var len__5769__auto___43594 = arguments.length;
var i__5770__auto___43595 = (0);
while(true){
if((i__5770__auto___43595 < len__5769__auto___43594)){
args__5775__auto__.push((arguments[i__5770__auto___43595]));

var G__43596 = (i__5770__auto___43595 + (1));
i__5770__auto___43595 = G__43596;
continue;
} else {
}
break;
...
(re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic = (function (p__43102){
var map__43103 = p__43102;
var map__43103__$1 = cljs.core.__destructure_map(map__43103);
var args = map__43103__$1;
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43103__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43103__$1,new cljs.core.Keyword(null,"model","model",331153215));
var regex_filter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43103__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
var debounce_delay = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43103__$1,new cljs.core.Keyword(null,"debounce-delay","debounce-delay",-608187982),(250));
var just_drop_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43103__$1,new cljs.core.Keyword(null,"just-drop?","just-drop?",-378249297));
...
var set_filter_text = (function (text,p__43128,debounce_QMARK_){
var map__43131 = p__43128;
var map__43131__$1 = cljs.core.__destructure_map(map__43131);
var args__$1 = map__43131__$1;
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43131__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
...
var G__43154 = cljs.core.deref(node);
var G__43154__$1 = (((G__43154 == null))?null:G__43154.getElementsByClassName("chosen-single"));
var G__43154__$2 = (((G__43154__$1 == null))?null:G__43154__$1.item((0)));
if((G__43154__$2 == null)){
return null;
} else {
return G__43154__$2.focus();
}
});
load_choices("",regex_filter_QMARK_,false);

return (function() { 
var re_com$dropdown$single_dropdown_render__delegate = function (p__43160){
var map__43162 = p__43160;
var map__43162__$1 = cljs.core.__destructure_map(map__43162);
var args__$1 = map__43162__$1;
var est_item_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43162__$1,new cljs.core.Keyword(null,"est-item-height","est-item-height",-264466439),(30));
var auto_complete_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"auto-complete?","auto-complete?",979505177));
var group_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43162__$1,new cljs.core.Keyword(null,"group-fn","group-fn",129203707),new cljs.core.Keyword(null,"group","group",582596132));
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var i18n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"i18n","i18n",-563422499));
var tooltip = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"tooltip","tooltip",-1809677058));
var model__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"model","model",331153215));
var free_text_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"free-text?","free-text?",1157444543));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43162__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263),new cljs.core.Keyword(null,"label","label",1718410804));
var tab_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"tab-index","tab-index",895755393));
var can_drop_above_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"can-drop-above?","can-drop-above?",-1140582782));
var repeat_change_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"repeat-change?","repeat-change?",-961675100));
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var title_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"title?","title?",-1510254555));
var render_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43162__$1,new cljs.core.Keyword(null,"render-fn","render-fn",398796518),label_fn);
var cancelable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43162__$1,new cljs.core.Keyword(null,"cancelable?","cancelable?",-986378679),true);
var set_to_filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"set-to-filter","set-to-filter",1270184073));
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var on_drop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"on-drop","on-drop",1867868491));
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
var choices__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43162__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798),new cljs.core.Keyword(null,"id","id",-1388402092));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var filter_placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"filter-placeholder","filter-placeholder",-1736876526));
var debounce_delay__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"debounce-delay","debounce-delay",-608187982));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var enter_drop_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43162__$1,new cljs.core.Keyword(null,"enter-drop?","enter-drop?",1054029717),true);
var tooltip_position = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"tooltip-position","tooltip-position",936197013));
var filter_box_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"filter-box?","filter-box?",-1157583688));
var capitalize_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43162__$1,new cljs.core.Keyword(null,"capitalize?","capitalize?",-2078576456));
...
var G__43216 = cljs.core.deref(internal_model);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__43216) : on_change.call(null,G__43216));
} else {
return null;
}
});
var callback = (function (p1__43036_SHARP_){
cljs.core.reset_BANG_(internal_model,(function (){var G__43217 = p1__43036_SHARP_;
...
return re_com.dropdown.capitalize_first_letter(G__43217);
} else {
return G__43217;
}
})());
...
var current_drop_showing_QMARK__43632 = cljs.core.deref(drop_showing_QMARK_);
if(cljs.core.truth_(current_drop_showing_QMARK__43632)){
focus_free_text();
} else {
}
...
cljs.core.reset_BANG_(drop_showing_QMARK_,cljs.core.not(current_drop_showing_QMARK__43632));
}
...
var free_text_change = (function (p1__43037_SHARP_){
cljs.core.reset_BANG_(internal_model,p1__43037_SHARP_);
...
var drop_was_showing_QMARK__43656 = cljs.core.deref(drop_showing_QMARK_);
call_on_change();
...
if(cljs.core.truth_((function (){var and__5043__auto__ = drop_was_showing_QMARK__43656;
if(cljs.core.truth_(and__5043__auto__)){
...
var key_handler = (function (p1__43047_SHARP_){
if(cljs.core.truth_(disabled_QMARK___$1)){
return false;
} else {
var G__43310 = p1__43047_SHARP_.which;
switch (G__43310) {
case (13):
return press_enter();
...
break;
case (9):
return press_tab(p1__43047_SHARP_.shiftKey);
...
})())?new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.dropdown.filter_text_box,filter_box_QMARK_,filter_text,key_handler,drop_showing_QMARK_,(function (p1__43057_SHARP_){
return set_filter_text(p1__43057_SHARP_,args__$1,true);
...
})())?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["error rc-dropdown-choices-error ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"choices-error","choices-error",2121956865),new cljs.core.Keyword(null,"class","class",-2030961996)], null)))].join(''),new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"choices-error","choices-error",2121956865),new cljs.core.Keyword(null,"style","style",-496642736)], null),cljs.core.PersistentArrayMap.EMPTY)], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"choices-error","choices-error",2121956865),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0)),new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state))], null):(((cljs.core.count(filtered_choices) > (0)))?(function (){var vec__43399 = re_com.dropdown.choices_with_group_headings(filtered_choices,group_fn);
var group_names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43399,(0),null);
var group_opt_lists = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43399,(1),null);
...
var make_choices = (function (p1__43059_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(make_a_choice,p1__43059_SHARP_);
});
...
var ___$2 = (cljs.core.truth_(on_drop)?cljs.core.add_watch(drop_showing_QMARK_,new cljs.core.Keyword(null,"on-drop","on-drop",1867868491),(function (p1__43068_SHARP_,p2__43069_SHARP_,p3__43066_SHARP_,p4__43067_SHARP_){
if(cljs.core.truth_((function (){var and__5043__auto__ = cljs.core.not(p3__43066_SHARP_);
if(and__5043__auto__){
return p4__43067_SHARP_;
} else {
return and__5043__auto__;
}
})())){
...
while (G__43735__i < G__43735__a.length) {G__43735__a[G__43735__i] = arguments[G__43735__i + 0]; ++G__43735__i;}
  p__43160 = new cljs.core.IndexedSeq(G__43735__a,0,null);
} 
return re_com$dropdown$single_dropdown_render__delegate.call(this,p__43160);};
re_com$dropdown$single_dropdown_render.cljs$lang$maxFixedArity = 0;
re_com$dropdown$single_dropdown_render.cljs$lang$applyTo = (function (arglist__43736){
var p__43160 = cljs.core.seq(arglist__43736);
return re_com$dropdown$single_dropdown_render__delegate(p__43160);
});
...
/** @this {Function} */
(re_com.dropdown.single_dropdown.cljs$lang$applyTo = (function (seq43071){
var self__5755__auto__ = this;
