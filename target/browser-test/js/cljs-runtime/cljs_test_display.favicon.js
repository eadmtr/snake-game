...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44232_SHARP_){
return html_coll.item(p1__44232_SHARP_);
...
return cljs.core.some((function (p1__44245_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__44245_SHARP_);
...
var ctx_44303 = cvs.getContext("2d");
(ctx_44303.fillStyle = color);

ctx_44303.fillRect((0),(0),size,size);
