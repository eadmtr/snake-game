...
var G__39215 = clojure.zip.node(loc);
var fexpr__39214 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__39214.cljs$core$IFn$_invoke$arity$1 ? fexpr__39214.cljs$core$IFn$_invoke$arity$1(G__39215) : fexpr__39214.call(null,G__39215));
});
/**
...
var G__39224 = clojure.zip.node(loc);
var fexpr__39223 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__39223.cljs$core$IFn$_invoke$arity$1 ? fexpr__39223.cljs$core$IFn$_invoke$arity$1(G__39224) : fexpr__39223.call(null,G__39224));
} else {
...
var fexpr__39226 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__39226.cljs$core$IFn$_invoke$arity$2 ? fexpr__39226.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__39226.call(null,node,children));
});
/**
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39232,(1),null);
var vec__39235 = clojure.zip.children(loc);
...
var vec__39242 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39242,(0),null);
var map__39245 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39242,(1),null);
var map__39245__$1 = cljs.core.__destructure_map(map__39245);
var path = map__39245__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39245__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39245__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39245__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39245__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39245__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__39257 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39257,(0),null);
var map__39260 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39257,(1),null);
var map__39260__$1 = cljs.core.__destructure_map(map__39260);
var path = map__39260__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39260__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__39261 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39260__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__39262 = cljs.core.seq(vec__39261);
var first__39263 = cljs.core.first(seq__39262);
var seq__39262__$1 = cljs.core.next(seq__39262);
var r = first__39263;
var rnext = seq__39262__$1;
var rs = vec__39261;
...
var vec__39268 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39268,(0),null);
var map__39271 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39268,(1),null);
var map__39271__$1 = cljs.core.__destructure_map(map__39271);
var path = map__39271__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39271__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39271__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return r;
} else {
...
var vec__39279 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39279,(0),null);
var map__39282 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39279,(1),null);
var map__39282__$1 = cljs.core.__destructure_map(map__39282);
var path = map__39282__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39282__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39282__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
...
var vec__39285 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39285,(0),null);
var map__39288 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39285,(1),null);
var map__39288__$1 = cljs.core.__destructure_map(map__39288);
var path = map__39288__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39288__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39288__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__39290 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39290,(0),null);
var map__39293 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39290,(1),null);
var map__39293__$1 = cljs.core.__destructure_map(map__39293);
var path = map__39293__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39293__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__39295 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39295,(0),null);
var map__39298 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39295,(1),null);
var map__39298__$1 = cljs.core.__destructure_map(map__39298);
var path = map__39298__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39298__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39300,(1),null);
...
var len__5769__auto___39400 = arguments.length;
var i__5770__auto___39401 = (0);
while(true){
if((i__5770__auto___39401 < len__5769__auto___39400)){
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq39310){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39311,G__39312,seq39310__$2);
}));
...
var G__39412 = clojure.zip.rightmost(child);
loc__$1 = G__39412;
continue;
} else {
return loc__$1;
...
var vec__39348 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39348,(0),null);
var map__39351 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39348,(1),null);
var map__39351__$1 = cljs.core.__destructure_map(map__39351);
var path = map__39351__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39351__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39351__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39351__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39351__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__39422 = clojure.zip.rightmost(child);
loc__$1 = G__39422;
continue;
} else {
return loc__$1;
