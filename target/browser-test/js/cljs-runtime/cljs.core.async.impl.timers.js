...
var i_31585 = (self__.level + (1));
while(true){
if((i_31585 <= (new_level + (1)))){
(update[i_31585] = self__.header);

var G__31587 = (i_31585 + (1));
i_31585 = G__31587;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_31591 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_31591[i]));
} else {
x__$2.forward.push((((i < links_31591.length))?(links_31591[i]):null));
}

if((i < links_31591.length)){
(links_31591[i] = x__$2);
} else {
links_31591.push(x__$2);
}
...
var i_31598 = (0);
while(true){
if((i_31598 <= self__.level)){
var links_31599 = (update[i_31598]).forward;
if((x__$1 === (((i_31598 < links_31599.length))?(links_31599[i_31598]):null))){
(links_31599[i_31598] = (x__$1.forward[i_31598]));

var G__31600 = (i_31598 + (1));
i_31598 = G__31600;
continue;
} else {
var G__31601 = (i_31598 + (1));
i_31598 = G__31601;
continue;
}
} else {
...
var G__31607 = nx;
var G__31608 = (level__$1 - (1));
x = G__31607;
level__$1 = G__31608;
continue;
} else {
var G__31611 = x;
var G__31612 = (level__$1 - (1));
x = G__31611;
level__$1 = G__31612;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__31617 = nx;
var G__31618 = (level__$1 - (1));
x = G__31617;
level__$1 = G__31618;
continue;
} else {
var G__31619 = x;
var G__31620 = (level__$1 - (1));
x = G__31619;
level__$1 = G__31620;
continue;
}
