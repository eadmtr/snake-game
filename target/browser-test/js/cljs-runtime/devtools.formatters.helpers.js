...
var G__31120 = devtools.prefs.pref(v);
v = G__31120;
continue;
} else {
return v;
...
}catch (e31011){var _e__29838__auto__ = e31011;
return false;
}})();
...
}catch (e31020){var _e__29838__auto__ = e31020;
return false;
}})();
...
}catch (e31028){var _e__29838__auto__ = e31028;
return false;
}}
}
});
...
var vec__31061 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31061,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31061,(1),null);
...
return cljs.core.some((function (p1__31079_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__31079_SHARP_);
}),template);
});
