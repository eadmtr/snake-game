...
var periods__$1 = cljs.core.vec((function (){var G__41878 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41875_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__41875_SHARP_,(0),(3));
}),G__41878);
} else {
return G__41878;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__41920){
var vec__41921 = p__41920;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41921,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41921,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__41924 = pattern;
switch (G__41924) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41924)].join('')));
...
return p1__41929_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__41930_SHARP_){
return p1__41930_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__41931_SHARP_){
return p1__41931_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__41932_SHARP_){
return p1__41932_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__41933_SHARP_){
return p1__41933_SHARP_.getHours();
});

break;
case "day":
return (function (p1__41934_SHARP_){
return p1__41934_SHARP_.getDate();
});

break;
case "month":
return (function (p1__41935_SHARP_){
return p1__41935_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__41936_SHARP_){
return p1__41936_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41938__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__41939){
var vec__41940 = p__41939;
var seq__41941 = cljs.core.seq(vec__41940);
var first__41942 = cljs.core.first(seq__41941);
var seq__41941__$1 = cljs.core.next(seq__41941);
var key = first__41942;
var args = seq__41941__$1;
var G__41943 = key;
var G__41943__$1 = (((G__41943 instanceof cljs.core.Keyword))?G__41943.fqn:null);
switch (G__41943__$1) {
case "millis":
...
break;
case "ordinal-suffix":
var vec__41946 = (function (){var G__41949 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__41949) : syntax_list.call(null,G__41949));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41943__$1)].join('')));
...
var d = value;
var G__41955 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__41956 = G__41955;
...
var unparser = first__41958;
var more = seq__41957__$1;
var s = "";
var d__$1 = d;
var G__41955__$1 = G__41955;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__41966 = G__41955__$1;
var seq__41967 = cljs.core.seq(vec__41966);
var first__41968 = cljs.core.first(seq__41967);
var seq__41967__$1 = cljs.core.next(seq__41967);
var unparser__$1 = first__41968;
var more__$1 = seq__41967__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__41969 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41969,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41969,(1),null);
var G__42053 = d__$3;
var G__42054 = more__$1;
var G__42055 = s__$3;
d__$1 = G__42053;
G__41955__$1 = G__42054;
s__$1 = G__42055;
continue;
}
break;
